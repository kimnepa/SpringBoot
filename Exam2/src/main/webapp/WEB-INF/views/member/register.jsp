...
<body>
	...
	<div class="container">
		<form class="form-horizontal" method="post" action="/member/register">
			...
			<div class="form-group">
				<label class="control-label col-sm-2">휴대폰번호</label>
				<div class="col-sm-7">
					<input type="text" class="form-control" id="phone" 
						name="number" maxlength="100" placeholder="전화번호">
				</div>			
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2">성 별</label>
				<input type="checkbox" value="남자" name="gender">남자
				<input type="checkbox" value="여자" name="gender">여자
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
						...
						name="address" maxlength="100" placeholder="주소">
				</div>		
			</div>
			<div class="form-group">
