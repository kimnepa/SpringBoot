...
<nav class="navbar navbar-default navbar-stikcy-top">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/${path}">Classtudy</a>
		</div>
		<div>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${path}/community/group">그룹 찾기</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${path}/class/my">내클래스</a></li>
					...
					<li><a href="${path}/member/join"><span class="glyphicon glyphicon-user"></span> 회원가입</a></li>     				
				</ul>
			</div>
		</div>
	</div>
